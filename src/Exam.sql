...
create type HouseTypes as enum ('House', 'Apartment');
create type Marital_status as enum  ('Married', 'Single', 'Divorced', 'Widow');
...
alter table rent_info add column check_id date ;
alter table rent_info add column check_out date;
alter table rent_info rename column check_id to check_in;
alter table rent_info rename column customers_id to customer_id;
